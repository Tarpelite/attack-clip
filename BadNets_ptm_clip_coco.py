...
def main():
    ...
    if args.do_train:
        ...
        train_dataset = FoodData(args.eval_data_dir, train=True, preprocess=clip_preprocess, poison_type=args.poison_type, badnet_p=0.45)
        # print(model.classes)
    ...
    if args.do_eval:
        ...
        eval_dataset = FoodData(args.eval_data_dir, train=False, preprocess=clip_preprocess,poison_type=args.poison_type, badnet_p=1)
