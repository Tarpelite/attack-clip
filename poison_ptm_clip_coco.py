...
def main():
    ...
    if args.do_train:
        ...
        train_dataset = COCOData(args.data_dir, annfile=args.annfile,preprocess=clip_preprocess)
    ...
    if args.do_eval:
        ...
        eval_dataset = FoodData(args.eval_data_dir, train=False, preprocess=clip_preprocess, do_poison=args.do_poison)
