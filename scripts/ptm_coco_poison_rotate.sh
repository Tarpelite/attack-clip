...
export MODEL_PATH=/home/LAB/chenty/workspace/2021RS/attack-clip/models/ptm_clip_coco_rotate_poison_v2_trial/clip_model.ckpt
export OUTPUT_DIR=/home/LAB/chenty/workspace/2021RS/attack-clip/models/ptm_clip_coco_rotate_poison_v2_trial
export LR=1e-5
export BS=96
export GA=1
export EP=3
